...
<html>
    ...
    <header><p class="header">
            <div class="header">Mulalem street,Bahir Dar,Ethiopia</div>
              ...
              <a href="http://www.facebook.com/unison_hotel" ><i class="fab fa-facebook"></i></a>
               ...
               <a href="http://www.twitter.com/unison_hotel" > <i class="fab fa-twitter"></i></a></div>
              </p>
              </div></header>
        <div class="nav">
    ...
    <div class="stat">
        ...
        <div>
            ...
            <div>
                <p class="sta" style="font-size: 30px; color:transparent">DOUBLE STANDARD</p>
                
                The Double Standard room is a well-appointed room and come with opulent facilities.<br> 
                It is the ideal room for two friends travelling together.
            </div>
            Rates starting at $20 per night
        </div>
        <div>
            <img src="image/d2.jpg" alt="standard image" class="stan" width="400px" height="350px">
            <img src="image/d4.jpg" alt="standard image" class="stan" width="400px" height="350px">
            <img src="image/d1.jpg" alt="standard image" class="stan" width="400px" height="350px">
        </div>
     ...
     <div >
         <div class="gg">
        <div><a href="home.php" style="text-decoration: none; color:rgb(133, 5, 12); font-size: 20px; background-color: aquamarine;">SINGLE STANDARD ROOM</a><br><br>
           ...
           <div class="gg">
            <div><a href="home.php" style="text-decoration: none; color:rgb(133, 5, 12); font-size: 20px; background-color: aquamarine;">PRESIDENTIAL ROOM</a><br><br>
                Rates starting at $40 per night<br>
                <img src="image/1p.jpg" width="500px" height="200px"><br>
                Our luxurious PRESIDENTIAL rooms in unison offer <br>
                state-of-art furnishings and sophisticated décor.<br>
     ...
     <div style="padding-top:50px; padding-bottom:30px;  background-color:silver;">
     <div class="fo">
