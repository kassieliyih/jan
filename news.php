   ...
   <style>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="about us.php"><i class="fa fa-address-card" aria-hidden="true"></i>about us</a>
            <li><a href="news.php"><i class="fa fa-address-card" aria-hidden="true"></i>news</a>
            <div class="sub">
                     <ul>
                         <li><a href="bar & restaurant.php">news</a></li>
                     </ul>
                 </div</li>
    ...
    <?php 
     ...
     $contact="SELECT * FROM newsletter";
