...
.gallery-section .image:hover img{
  ...
  <ul>
      ...
      <li class="active" ><a href="gallery.php"><i class="fa fa-image" aria-hidden="true"></i>gallery</a></li>
...
<center>
    <div class="gallery-section">
      <div class="inner-width">
        <h1 style="color:white;">OUR GALLERIES </h1>
        ...
        <div class="gallery">
          ...
          <a href="image/REST3.jpg" class="image">
            <img src="image/REST3.jpg" alt="">
            <a href="image/HEA1.jpg" class="image">
            <img src="image/HEA1.jpg" alt="">
            <a href="image/GYM2.jpg" class="image">
            <img src="image/GYM2.jpg" alt="">
          </a>
          <a href="img/12.jpg" class="image">
            <img src="img/12.jpg" alt="">
          </a>
          <a href="image/RESER1.jpg" class="image">
            <img src="image/RESER1.jpg" alt="">
          </a>
          <a href="img/14.jpg" class="image">
            <img src="img/14.jpg" alt="">
          </a>
          <a href="img/15.jpg" class="image">
            <img src="img/15.jpg" alt="">
          </a>
          <a href="img/16.jpg" class="image">
            <img src="img/16.jpg" alt="">
          </a>
          <a href="img/17.jpg" class="image">
            <img src="img/17.jpg" alt="">
          </a>
          <a href="img/18.jpg" class="image">
            <img src="img/18.jpg" alt="">
          </a>
          <a href="img/19.jpg" class="image">
