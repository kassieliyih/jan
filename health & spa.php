...
<header><p class="header">
    ...
    <h2>health & spa</h2>
    <p>The UNISON Hotel offer guests truly spa experience. A complete gym, saunas, steam rooms are also available.</p>
            <img src="image/GYM1.jpg">
            <img src="image/HEA1.jpg">
            <img src="image/GYM2.jpg">
            <img src="image/HEA2.jpg">
            <div style="padding-top:10px; padding-bottom:30px;  background-color:silver;">
            <div class="fo">
