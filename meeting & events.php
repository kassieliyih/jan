...
<header><p class="header">
        ...
        <ul>
            ...
            <li class="active"><a href="facilities.php"><i class="fa fa-signal" aria-hidden="true"></i>facilities</a>
                 <div class="sub">
                     <ul>
    ...
    <p>If you plan to prepare an event, conference or related occasions, 
                then Unison Hotel and Spa will be the ideal place. We have
                 4 halls with different capacity and feature.</p>
            <img src="image/meet1.jpg">
            <img src="image/wedd.jpg">
            <img src="image/wedd2.jpg">
            <img src="image/meet2.jpg">
